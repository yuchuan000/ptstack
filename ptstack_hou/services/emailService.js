...
export const sendAnnouncementEmail = async (to, username, title, content) => {
  try {
    ...
    const styledHtmlContent = htmlContent
      .replace(
        /<h1/g,
        '<h1 style="font-size: 22px; font-weight: 700; color: #1d2129; margin: 20px 0 12px 0; padding-bottom: 8px; border-bottom: 2px solid #165dff;"',
      )
      .replace(
        /<h2/g,
        '<h2 style="font-size: 18px; font-weight: 600; color: #1d2129; margin: 16px 0 10px 0;"',
      )
      .replace(
        /<h3/g,
        '<h3 style="font-size: 16px; font-weight: 600; color: #1d2129; margin: 14px 0 8px 0;"',
      )
      .replace(
        /<p/g,
        '<p style="font-size: 15px; color: #4e5969; line-height: 1.75; margin: 10px 0;"',
      )
      .replace(/<ul/g, '<ul style="padding-left: 24px; margin: 10px 0;"')
      .replace(/<ol/g, '<ol style="padding-left: 24px; margin: 10px 0;"')
      .replace(
        /<li/g,
        '<li style="font-size: 15px; color: #4e5969; line-height: 1.75; margin: 5px 0;"',
      )
      .replace(
        /<a /g,
        '<a style="color: #165dff; text-decoration: none; font-weight: 500; border-bottom: 1px solid rgba(22, 93, 255, 0.3);" ',
      )
      .replace(/<strong>/g, '<strong style="color: #1d2129; font-weight: 600;">')
      .replace(
        /<code>/g,
        '<code style="background: #f7f8fa; padding: 3px 8px; border-radius: 4px; font-size: 14px; color: #d03050; font-family: Consolas, Monaco, "Courier New", monospace;"',
      )
      .replace(
        /<pre>/g,
        '<pre style="background: #f7f8fa; padding: 16px; border-radius: 8px; overflow-x: auto; margin: 14px 0; border: 1px solid #e5e6eb;"',
      )
      .replace(
        /<pre><code>/g,
        '<pre style="background: #f7f8fa; padding: 16px; border-radius: 8px; overflow-x: auto; margin: 14px 0; border: 1px solid #e5e6eb;"><code style="color: #1d2129; font-size: 14px; font-family: Consolas, Monaco, "Courier New", monospace; background: none; padding: 0; line-height: 1.6;"',
      )
      .replace(
        /<blockquote>/g,
        '<blockquote style="border-left: 4px solid #165dff; padding: 12px 16px; margin: 14px 0; background: #f2f3f5; border-radius: 0 6px 6px 0; color: #4e5969; font-style: normal;"',
      )
...
export const sendCategoryApplicationEmail = async (
  to,
  username,
  categoryName,
  description,
...
export const sendCategoryReviewEmail = async (
  to,
  username,
  categoryName,
  action,
