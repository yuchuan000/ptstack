...
export const getListController: RequestHandler = async (req, res) => {
  const query = req.validated?.query as category.GetListQuery
...
export const getDetailController: RequestHandler = async (req, res) => {
  const params = req.validated?.params as category.GetDetailParams
...
export const addController: RequestHandler = async (req, res) => {
  const body = req.validated?.body as category.AddBody
...
export const updateController: RequestHandler = async (req, res) => {
  const params = req.validated?.params as category.UpdateParams
  const body = req.validated?.body as category.UpdateBody
...
export const softDeleteManyController: RequestHandler = async (req, res) => {
  const body = req.validated?.body as category.OperateManyBody
...
export const softDeleteController: RequestHandler = async (req, res) => {
  const params = req.validated?.params as category.OperateParams
